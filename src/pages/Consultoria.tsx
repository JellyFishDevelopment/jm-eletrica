  ...
  return (
    <div>
      ...
      <div className="p-8 sm:p-16 h-96 text-white bg-[#818181]">
        <h1 className="text-center font-bold text-5xl sm:text-8xl">Consultoria</h1>
        <p className="font-light text-center text-xl sm:text-4xl mt-8">
          A consultoria elétrica tem como enfoque direcionar forma de economizar energia e dinheiro, sendo assim, essa consultoria tem como função encontrar as necessidades de cada empreendimento e auxiliá-lo a encontrar formas de economizar energia.{' '}
        </p>
      </div>
      {/* Laudos */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-32">
        <div className="bg-[#969696] mx-auto text-white p-8  w-3/4 sm:w-3/4 rounded-xl">
          <h3 className="font-bold text-center text-4xl">Consultor em análise de qualidade de energia</h3>
        ...
        <div className="bg-[#969696] mx-auto text-white p-8 w-3/4 sm:w-3/4 rounded-xl">
          <h3 className="font-bold text-center text-4xl">Consultor para Credito de ICMS</h3>
          <p className="font-light text-xl my-4">
